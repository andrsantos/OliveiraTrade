...
<html lang="en">
  ...
  <%
    ...
    if(msg == null){
    	System.out.println("Mensagem nula, não faça nada!");
    } else{
    if(msg.equals("Cadastro realizado com sucesso")){
    	out.println("<div  class=\"alert alert-success\" id=\"alerta\" onclick=\"fechaAlerta()\" role=\"alert\">Cadastro realizado com sucesso!  Clique para fechar</div>");
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="cadastro-container-login">
       <form action="http://localhost:8006/OliveiraTrade/ControladorDoCliente" method="post">
        ...
        <input type="text" name="cpf" class="form-control" placeholder="Digite seu cpf..." aria-label="Username" aria-describedby="basic-addon1" type="text" maxlength="14">
        </div>
        <div class="input-group mb-3">
        ...
        <textarea class="form-control" name="endereco" aria-label="With textarea"></textarea>
      	...
      	<input type="hidden" name="tipoformulario" value="cadastro">
    ...
    <div class="form-login">
        <form class="margin" method="post" action="http://localhost:8006/OliveiraTrade/ControladorDoCliente">
        <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Usuário</span>
        <input type="text" name="email" class="form-control" placeholder="EMAIL do usuário..." aria-label="Username" aria-describedby="basic-addon1"  maxlength="50">
        </div>
       ...
       <input type="hidden" name="tipoformulario" value="login">
